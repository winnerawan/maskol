...
public class SwipeButtonPrice extends RelativeLayout {
...
//    private OnActiveListener onActiveListener;
    ...
    public SwipeButtonPrice(Context context) {
        super(context);

        init(context, null, -1, -1);
    }

    public SwipeButtonPrice(Context context, AttributeSet attrs) {
        super(context, attrs);

        init(context, attrs, -1, -1);
    }

    public SwipeButtonPrice(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public SwipeButtonPrice(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs != null && defStyleAttr == -1 && defStyleRes == -1) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.SwipeButtonPrice,
                    defStyleAttr, defStyleRes);

            collapsedWidth = (int) typedArray.getDimension(R.styleable.SwipeButtonPrice_button_image_width,
                    ViewGroup.LayoutParams.WRAP_CONTENT);
            collapsedHeight = (int) typedArray.getDimension(R.styleable.SwipeButtonPrice_button_image_height,
                    ViewGroup.LayoutParams.WRAP_CONTENT);
            trailEnabled = typedArray.getBoolean(R.styleable.SwipeButtonPrice_button_trail_enabled,
                    false);
            Drawable trailingDrawable = typedArray.getDrawable(R.styleable.SwipeButtonPrice_button_trail_drawable);

            Drawable backgroundDrawable = typedArray.getDrawable(R.styleable.SwipeButtonPrice_inner_text_background);

            if (backgroundDrawable != null) {
                background.setBackground(backgroundDrawable);
            } else {
                background.setBackground(ContextCompat.getDrawable(context, R.drawable.shape_point_value));
            }
            ...
            if (trailEnabled) {
                ...
                if (trailingDrawable != null) {
                    ...
                    layer.setBackground(typedArray.getDrawable(R.styleable.SwipeButtonPrice_button_background));
                }
            ...
            centerText.setText(typedArray.getText(R.styleable.SwipeButtonPrice_inner_text));
            centerText.setTextColor(typedArray.getColor(R.styleable.SwipeButtonPrice_inner_text_color,
                    Color.WHITE));

            float textSize = DimentionUtils.converPixelsToSp(
                    typedArray.getDimension(R.styleable.SwipeButtonPrice_inner_text_size, 0), context);
            ...
            disabledDrawable = typedArray.getDrawable(R.styleable.SwipeButtonPrice_button_image_disabled);
            enabledDrawable = typedArray.getDrawable(R.styleable.SwipeButtonPrice_button_image_enabled);
            float innerTextLeftPadding = typedArray.getDimension(
                    R.styleable.SwipeButtonPrice_inner_text_left_padding, 0);
            float innerTextTopPadding = typedArray.getDimension(
                    R.styleable.SwipeButtonPrice_inner_text_top_padding, 0);
            float innerTextRightPadding = typedArray.getDimension(
                    R.styleable.SwipeButtonPrice_inner_text_right_padding, 0);
            float innerTextBottomPadding = typedArray.getDimension(
                    R.styleable.SwipeButtonPrice_inner_text_bottom_padding, 0);

            int initialState = typedArray.getInt(R.styleable.SwipeButtonPrice_initial_state, DISABLED);
            ...
            Drawable buttonBackground = typedArray.getDrawable(R.styleable.SwipeButtonPrice_button_background);

            if (buttonBackground != null) {
                swipeButtonInner.setBackground(buttonBackground);
            } else {
                swipeButtonInner.setBackground(ContextCompat.getDrawable(context, R.drawable.shape_price));
            }

            buttonLeftPadding = typedArray.getDimension(R.styleable.SwipeButtonPrice_button_left_padding, 0);
            buttonTopPadding = typedArray.getDimension(R.styleable.SwipeButtonPrice_button_top_padding, 0);
            buttonRightPadding = typedArray.getDimension(R.styleable.SwipeButtonPrice_button_right_padding, 0);
            buttonBottomPadding = typedArray.getDimension(R.styleable.SwipeButtonPrice_button_bottom_padding, 0);
            ...
            hasActivationState = typedArray.getBoolean(R.styleable.SwipeButtonPrice_has_activate_state, true);
