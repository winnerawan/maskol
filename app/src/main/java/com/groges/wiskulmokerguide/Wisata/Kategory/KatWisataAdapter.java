...
public class KatWisataAdapter extends RecyclerView.Adapter<KatWisataAdapter.ItemHolder> {
    private List<ListKatWisata> listItems;
    private Context context;
    private OnItemClickListener mListener;


    public KatWisataAdapter(List<ListKatWisata> listItems, Context context) {
    ...
    public void onBindViewHolder(@NonNull ItemHolder holder, int position) {
        ListKatWisata listItem = listItems.get(position);
