...
public class DetailKuliner extends AppCompatActivity implements OnMapReadyCallback {
    private static final String TABEL = "spotKuliner";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idTempat = intent.getStringExtra("idKuliner");
        nmTempat = intent.getStringExtra("nmKuliner");
