package com.groges.wiskulmokerguide.Kuliner;
 ...
 */
public class KulinerFragment extends Fragment implements KulinerAdapter.OnItemClickListener {
    private static final String TABEL_MENU = "spotKuliner" ;
    private RecyclerView recyclerView;
    private List<ListKuliner> listItems;
    private KulinerAdapter myAdapter;
...
//    private FirebaseStorage mStorage;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myAdapter = new KulinerAdapter(listItems,getActivity());
        myAdapter.setOnItemClickListener(KulinerFragment.this);
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                for (DocumentSnapshot document : task.getResult()) {
                                    listItems.add(new ListKuliner(document.getId(),
    ...
    public void onItemClick(int position) {
        ListKuliner selectedItem = listItems.get(position);
        Intent intent = new Intent(getActivity(), DetailKuliner.class);
