...
import com.groges.wiskulmokerguide.Hotel.ListHotel;
import com.groges.wiskulmokerguide.R;
import com.squareup.picasso.Picasso;

import java.util.List;

public class KulinerAdapter extends RecyclerView.Adapter<KulinerAdapter.ItemHolder> {
    private List<ListKuliner> listItems;
    private Context context;
    private OnItemClickListener mListener;


    public KulinerAdapter(List<ListKuliner> listItems, Context context) {
    ...
    public void onBindViewHolder(@NonNull ItemHolder holder, int position) {
        ListKuliner listItem = listItems.get(position);
