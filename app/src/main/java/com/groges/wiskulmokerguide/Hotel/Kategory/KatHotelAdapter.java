...
public class KatHotelAdapter extends RecyclerView.Adapter<KatHotelAdapter.ItemHolder> {
    private List<ListKatHotel> listItems;
    private Context context;
    private OnItemClickListener mListener;


    public KatHotelAdapter(List<ListKatHotel> listItems, Context context) {
    ...
    public void onBindViewHolder(@NonNull ItemHolder holder, int position) {
        ListKatHotel listItem = listItems.get(position);
