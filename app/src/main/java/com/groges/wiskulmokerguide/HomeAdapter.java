...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.ItemHolder> {
    ...
    public HomeAdapter(List<ListMenu> listItems, Context context) {
    ...
    public void onBindViewHolder(@NonNull ItemHolder holder, int position) {
        ...
        if(listItem.getHarga()!=null) {
            harga=String.valueOf(listItem.getHarga());
        }else{
            harga="-";
        }
...
//        }
    ...
    public class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener,
        ...
        public TextView txtNama, txtNmTempat;
        SwipeButtonPrice txtHarga;
        ...
        public ItemHolder(View itemView) {
            super(itemView);
            txtNama = itemView.findViewById(R.id.home_lst_txtNama);
            txtNmTempat = itemView.findViewById(R.id.home_lst_txtTempat);
            txtHarga = itemView.findViewById(R.id.home_lst_txtHarga);
            //imgTempat = itemView.findViewById(R.id.home_lst_imgTempat);
            imgMenu = itemView.findViewById(R.id.home_lst_img);
